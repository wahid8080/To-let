...
public class FragmentFlat extends Fragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v;
        v = inflater.inflate(R.layout.flat_fragment,container,false);
        ...
        databaseReference2 = FirebaseDatabase.getInstance().getReference("UploadData").child("Flat");
        ...
        databaseReference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                productAdepter = new ProductAdepter(getActivity(), (ArrayList<UploadRoomFlat>) uploadRoomFlatArrayList,"Flat");
