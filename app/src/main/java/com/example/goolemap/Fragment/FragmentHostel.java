...
public class FragmentHostel extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v;
        v  = inflater.inflate(R.layout.hostel_fragment,container,false);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                productAdepter = new ProductAdepter(getActivity(), (ArrayList<UploadRoomFlat>) uploadRoomFlatArrayList,"Hostel");
